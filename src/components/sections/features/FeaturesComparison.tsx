    ...
    <section aria-label="Features comparison section" className="py-20">
      <div className="flex flex-col gap-8">
        ...
        <ScrollReveal variant="fade-blur" className="grid grid-cols-1 md:grid-cols-2 w-content-width md:w-6/10 mx-auto gap-5">
          <div className="flex flex-col gap-3 xl:gap-4 2xl:gap-5 p-3 xl:p-4 2xl:p-5 card rounded opacity-50">
          ...
          <div className="flex flex-col gap-3 xl:gap-4 2xl:gap-5 p-3 xl:p-4 2xl:p-5 card rounded">
