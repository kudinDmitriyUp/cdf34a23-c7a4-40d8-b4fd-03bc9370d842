...
const BlogCardItem = ({ item }: { item: BlogItem }) => {
  ...
  return (
    <article
      className="card group flex flex-col gap-3 xl:gap-4 2xl:gap-5 p-3 xl:p-4 2xl:p-5 rounded cursor-pointer"
      onClick={handleClick}
    >
      ...
      <div className="flex flex-1 flex-col justify-between gap-3 xl:gap-4 2xl:gap-5">
