  ...
  <section aria-label="Team section" className="py-20">
    <div className="flex flex-col gap-5 md:gap-8 w-content-width mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-start gap-8">
        <span className="hidden md:block px-3 py-1 mb-1 text-sm card rounded">{tag}</span>
        ...
        >
          {members.map((member) => (
            <div key={member.name} className="flex flex-col gap-3 xl:gap-4 2xl:gap-5 p-3 xl:p-4 2xl:p-5 card rounded overflow-hidden">
