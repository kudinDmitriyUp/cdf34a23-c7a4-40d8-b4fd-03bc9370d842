  ...
  return (
    <section aria-label="Testimonials section" className="py-20">
      <div className="flex flex-col items-center gap-5 w-content-width mx-auto">
        <ScrollReveal variant="fade" className="flex gap-1">
        ...
        <ScrollReveal variant="fade" delay={0.1} className="text-xl text-center">
          <p>{author}</p>
        </ScrollReveal>

        <ScrollReveal variant="fade" delay={0.2} className="flex items-center justify-center">
